...
echo "\e                     SCRIPT GOJEK by Aris Nur Cholis     \n";

echo "\n";

nope:

echo "\e[?] Masukkan Nomor HP lo Wajib no loya +62 : ";
...
if ($cek == false)
    ...
    echo "\e[x] Nomor Telah Terdaftar loh anjink \n";
...
if ($register == false)
    ...
    if ($verif == false)
		...
		fclose($h); 
            ...
            echo "\e[!] Failed to Claim Voucher, claim sendiri su gak usah manja\n";
